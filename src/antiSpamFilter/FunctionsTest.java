...
public class FunctionsTest {
	...
	/**
	 * Returns FP and FN in a String[] of a given line. To test this we created a test String[] with the FN and FB expected and then
	 * was called the function to verify if every element of the return String[] equals the correspondent element of the test String[].
	 * @throws FileNotFoundException
	 */
	@Test
	public final void testGet_FalseValues() throws FileNotFoundException{
		String[] expectedList = new String[4];
		expectedList[0] = "4.0";
		expectedList[1] = "2.0";
		expectedList[2] = "-1.0";
		expectedList[3] = "-4.0";
		String[] actualList = Functions.getFalseValues(2, NSGAII_2);
		for(int i = 0; i != actualList.length; i++){
			assertEquals("failure - element should be same", expectedList[i], actualList[i]);
		}
	}
